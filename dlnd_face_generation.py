...
def get_dataloader(batch_size, image_size, data_dir='processed_celeba_small/'):
    ...
    data = datasets.ImageFolder(data_dir, transform=transformer)
...
def conv(in_channel, out_channel, kernel_size=4, stride=2, padding=1, batch_norm=True):
    
        layers = []
        
        conv_lay = nn.Conv2d(in_channel, out_channel, kernel_size=kernel_size, stride=stride, padding=padding, bias=False)
        
        layers.append(conv_lay)
...
class Discriminator(nn.Module):
    ...
    def __init__(self, conv_dim):
        ...
        # out 16*16
        self.conv2 = conv(self.conv_dim, self.conv_dim*2)
        # out 8*8
        self.conv3 = conv(self.conv_dim*2, self.conv_dim*4)
        # out 4*4
        self.conv4 = conv(self.conv_dim*4, self.conv_dim*8)
        # out 2*2
...
def deconv(in_channel, out_channel, kernel_size=4, stride=2, padding=1, batch_norm=True):
    
        layers = []
        
        deconv = nn.ConvTranspose2d(in_channel, out_channel, kernel_size=kernel_size, stride=stride, padding=padding, bias=False)
